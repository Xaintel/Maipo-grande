...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>Puedes mirar mas de nuestros productos presionando <a href="../realizarComprasInterno.jsp" style="text-decoration: none; color: black; font-weight: bold;">AQUÍ.</a></p>
            <p>Muchas gracias por comprar en Maipo Grande te agradecemos tu apoyo!</p>
            <p><a href="../ClienteInterno.jsp" style="text-decoration: none; color: black; font-weight: bold; ">Presiona aqui para volver al menu principal</a></p>
        </div>
    </body>
</html>
