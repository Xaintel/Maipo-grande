...
<html>
    ...
    <body>
        ...
        <form>
            ...
            <h2 style="margin-left: 170px; font-size: 30px; color: black;">Todos</h2>
            ...
            <table class="content-table">
                ...
                <tbody>
                    <%
                        String SqlCorreo = "SELECT * FROM CORREO WHERE nombre_usuario_enviado_a = '" + user_http + "' order by id_correo desc";
