...
<html>
    ...
    <body>
        ...
        <form>
            ...
            <h2 style="margin-left: 170px; font-size: 30px; color: black;">Correos Vistos</h2>
            ...
            <table class="content-table">
                ...
                <tbody>
                    <%
                        String SqlCorreo = "SELECT * FROM CORREO WHERE nombre_usuario_enviado_a = '" + user_http + "' and correo_visto = 'SI' order by id_correo desc";
