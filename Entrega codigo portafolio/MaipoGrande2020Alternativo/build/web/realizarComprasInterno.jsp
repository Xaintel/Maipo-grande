...
<html>
    ...
    <form>
        <table class="content-table">
            ...
            <tbody>
                <%                                        String sql_compra = "SELECT P.NOMBRE_PRODUCTO, PV.PESO_PRODUCTO, PV.PRECIO_PRODUCTO, PV.COD_VENTA FROM PRODUCTO_VENTA PV \n "
                ...
                <tr>
                    ...
                    <td><a href="comprarProductosInterno/compraProductos.jsp?cod=<%=rs.getString(4)%>">Comprar</a></td>
