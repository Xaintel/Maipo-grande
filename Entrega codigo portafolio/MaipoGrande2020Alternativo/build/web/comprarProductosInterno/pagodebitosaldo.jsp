...
<html>
    ...
    <body>
        ...
        <form class="container">
            ...
            <input type="text" style="display: none" name="txtidproducto" value="<%=codigo%>"> 
            <%
            ...
            <div style="border-bottom: 2px solid black"> 
                ...
                <br><br>
                <a style="font-size: 20px">El pago a realizar es de: $ <%=rs.getString(6)%></a>
                <br><br>
            </div>
            <br><br>
            <%
            ...
            if (request.getParameter("btnComprar") != null) {
                ...
                try {
                    ...
                    String insertdebito = "INSERT INTO REGISTRO_VENTA_PRODUCTO \n "
                            + "VALUES (SEQ_REGISTRO_VENTA_PRODUCTO.nextval, '" + idproducto + "', '" + rutcliente + "',(SELECT TO_CHAR(SYSDATE, 'DD/MM/YYYY') FROM DUAL),'DEBITO','" + banco + "','" + rut + "',NULL,'" + pago + "')";
                    String updatesaldo = "UPDATE PRODUCTO_VENTA SET COMPRADO = 'SI' WHERE COD_VENTA = '" + idproducto + "'";
