...
<html>
    ...
    <body>
        ...
        <form class="container">
            ...
            <input type="text" style="display: none" name="txtcodventa" value="<%=codigo%>"> 
            <%
                String saldosql = "SELECT * FROM PRODUCTO_VENTA WHERE COD_VENTA = " + codigo + "";
                ps = cn.prepareStatement(saldosql);
                rs = ps.executeQuery();
                while (rs.next() == true) {
            %>
            <div style="border-bottom: 2px solid black"> 
                <input style="display: none"type="text" name="txtpago" value="<%=rs.getString(6)%>"> 
                <br>
                ...
                <br><br>
                <a style="font-size: 20px">El pago a realizar es de: $ <%=rs.getString(6)%> con credito</a>
                <br><br>
            </div>
            <br><br>
            <%
        ...
        <%
            if (request.getParameter("btnComprar") != null) {
                ...
                String codventa = request.getParameter("txtcodventa");
                String pago = request.getParameter("txtpago");
                try {
                    st = cn.createStatement();
                    String insertdebito = "INSERT INTO REGISTRO_VENTA_PRODUCTO \n "
                            + "VALUES (SEQ_VENTA_SALDO.nextval, '" + codventa + "', '" + rutcliente + "',(SELECT TO_CHAR(SYSDATE, 'DD/MM/YYYY') FROM DUAL),'DEBITO','" + banco + "',NULL,'" + tarjeta + "','" + pago + "')";
                    String updatesaldo = "UPDATE PRODUCTO_VENTA SET COMPRADO = 'SI' WHERE COD_VENTA = '" + codventa + "'";
