<%-- 
    Document   : listadoParticipantes
    Created on : 01-11-2020, 22:23:59
    Author     : inter
--%>
...
<html>
    ...
    <body>
        ...
        <h1 style="    font-size: 20px;
            ...
            margin-top: 30px;
            font-weight: bold;
            margin-left: 30px;">Listado de participantes</h1>
        ...
        <table class="content-table">
            ...
            <tbody>
                <%
                    String sql_procesoventa = "SELECT  DISTINCT dpv.RUT_USUARIO, u.nombre || ' ' || u.apellido_paterno || ' ' || u.apellido_materno as nombre_completo, u.nombre_usuario, dpv.id_venta,  pv.titulo_venta \n "
                            + "FROM DETALLE_PROCESO_VENTA dpv \n "
                            + "join usuario u on u.rut_usuario = dpv.rut_usuario join proceso_venta pv on pv.id_venta = dpv.id_venta  where dpv.show = 'YES' ";
                ...
                <tr class="active-row">
                    ...
                    <td><a href="listadoParticipantesProductos.jsp?rut=<%=rs.getString(1)%>&idventa=<%=rs.getString(4)%>">Detalle</a></td>
                </tr>
                <%
                    }
                %>
